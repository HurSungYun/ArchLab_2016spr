...
int gen_need_valC()
{
    return ((if_id_next->icode) == (I_IRMOVL) || (if_id_next->icode) == 
      ...
      (if_id_next->icode) == (I_JMP) || (if_id_next->icode) == (I_CALL) || 
      (if_id_next->icode) == (I_IADDL) || (if_id_next->icode) == (I_ISUBL))
    ;
}
...
int gen_d_dstE()
{
    return (((if_id_curr->icode) == (I_RRMOVL) || (if_id_curr->icode) == 
        (I_IRMOVL) || (if_id_curr->icode) == (I_ALU) || (if_id_curr->icode)
         == (I_IADDL) || (if_id_curr->icode) == (I_ISUBL)) ? 
      (if_id_curr->rb) : ((if_id_curr->icode) == (I_PUSHL) || 
        (if_id_curr->icode) == (I_POPL) || (if_id_curr->icode) == (I_CALL)
         || (if_id_curr->icode) == (I_RET) || (if_id_curr->icode) == 
        (I_LEAVE)) ? (REG_ESP) : (REG_NONE));
}
...
int gen_aluA()
{
    return (((id_ex_curr->icode) == (I_RRMOVL) || (id_ex_curr->icode) == 
        ...
        (id_ex_curr->icode) == (I_ISUBL)) ? (id_ex_curr->valc) : (
...
int gen_aluB()
{
    return (((id_ex_curr->icode) == (I_RMMOVL) || (id_ex_curr->icode) == 
        ...
        (I_IADDL) || (id_ex_curr->icode) == (I_ISUBL)) ? (id_ex_curr->valb)
...
int gen_alufun()
{
    return (((id_ex_curr->icode) == (I_ALU)) ? (id_ex_curr->ifun) : (
        (id_ex_curr->icode) == (I_IADDL)) ? (A_ADD) : ((id_ex_curr->icode)
         == (I_ISUBL)) ? (A_SUB) : (A_ADD));
}
...
int gen_set_cc()
{
    return ((((id_ex_curr->icode) == (I_ALU) || (id_ex_curr->icode) == 
          (I_IADDL) || (id_ex_curr->icode) == (I_ISUBL)) & !(
